...
Paired with the Module E run for the same target (`../../module_e_normal_tissue_risk/question/tgt_erbb2.md`). Same `indication_id=mcrc_preop_chemotherapy_crlm` territory and dataset pair (`GSE178318` local, `GSE225857` blocked) as `tgt_ceacam5`.
