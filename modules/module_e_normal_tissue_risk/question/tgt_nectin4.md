...
`NECTIN4` is the target of enfortumab vedotin (approved, urothelial cancer). No clinical-literature toxicity claim is asserted or checked against here — this pass does not query external clinical literature (corrected 2026-08-24, PR #76 round 1 review, same correction as `tgt_erbb2.md`). This run reports only what this repository's own screen shows.
