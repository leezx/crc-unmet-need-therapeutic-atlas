...
|---|---:|---:|---:|---|
| permissive | 100 / 300 | 140,122 | 6 | QC_STABLE |
| primary | 200 / 500 | 139,543 | 6 | REFERENCE |
| stringent | 300 / 1,000 | 136,373 | 6 | QC_STABLE |

The permissive and stringent runs retained the same six matched patients as the primary rule, and no sample crossed the defined >20% retained-cell change threshold relative to the primary rule. This is a QC retention result only; it does not establish a malignant state, plasticity program, therapeutic target or clinical indication.
