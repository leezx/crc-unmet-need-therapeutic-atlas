...
- source-only evidence objects 由公开 PR #33 提出；EV003 URL、EV008 计数措辞、EV001/EV002 supporting-text 路径、source-only 状态措辞和 inventory 统计已按网页版审核修正；历史批准 head 为 `35a34df`，当前 head `99c7722` 待最终复核
