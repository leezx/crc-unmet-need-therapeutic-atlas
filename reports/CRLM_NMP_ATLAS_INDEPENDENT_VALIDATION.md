# CRLM-NMP-ATLAS external cohort coverage audit
...
Results are exploratory: epithelial identity mean difference was +0.105775 (5/6 positive; exact sign-flip p=0.125), plasticity anchor −0.005247 (4/6 positive; p=0.90625), and noncanonical anchor −0.001571 (2 positive, 1 negative; p=1.0; remaining donors lacked both malignant groups). Because this cohort compares CRLM with adjacent liver rather than matched primary CRC with liver metastasis, it is an external coverage/descriptive audit and not equivalent independent validation of the locked contrast. It is not causal evidence, target ranking, therapeutic-window evidence or a clinical recommendation.
