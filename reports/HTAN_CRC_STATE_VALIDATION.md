# HTAN CRC progressive-plasticity independent validation
...
The plasticity-anchor direction is concordant in 18/25 matched pairs in this independent cohort. This is an exploratory replication of the marker-score direction, not proof of malignancy, causality, target actionability or clinical benefit. Cell-cycle and stress scores are reported separately and excluded from state scores. The full result remains local and ignored at `phase2/06_results/HTAN_CRC_progressive_plasticity/validation.json`.
