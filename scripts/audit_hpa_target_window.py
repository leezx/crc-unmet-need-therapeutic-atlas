...
def main() -> None:
    ...
    output = {"dataset": "HPA_normal_tissue_v25.1", "targets": TARGETS, "genes": result, "interpretation_boundary": "Normal-tissue RNA/protein coverage audit only; no therapeutic window, safety claim, target approval or clinical recommendation."}
